...
namespace Quraaa.Persistence.Migrations
{
    ...
    [Migration("20260816094004_AddBookReviewsTableAndDropLegacy")]
    partial class AddBookReviewsTableAndDropLegacy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quraaa.Domain.Catalog.BookVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("RevertedFromVersionNumber")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("BookId", "VersionNumber")
                        .IsUnique();

                    b.ToTable("BookVersions", null, t =>
                        {
                            t.HasCheckConstraint("CK_BookVersions_RevertedFrom_Consistent", "(\"Reason\" = 3 AND \"RevertedFromVersionNumber\" IS NOT NULL) OR (\"Reason\" <> 3 AND \"RevertedFromVersionNumber\" IS NULL)");

                            t.HasCheckConstraint("CK_BookVersions_VersionNumber_Positive", "\"VersionNumber\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Quraaa.Domain.Marketplace.ListingAggregate", b =>
                {
                    ...
                    b.Property<string>("CustomCoverImageUrl")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");
            ...
            modelBuilder.Entity("Quraaa.Domain.Notifications.BookModerationNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BookModerationNotifications", (string)null);
                });
