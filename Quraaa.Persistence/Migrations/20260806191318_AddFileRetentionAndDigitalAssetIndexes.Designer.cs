...
namespace Quraaa.Persistence.Migrations
{
    ...
    [Migration("20260806191318_AddFileRetentionAndDigitalAssetIndexes")]
    partial class AddFileRetentionAndDigitalAssetIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quraaa.Domain.Marketplace.ListingAggregate", b =>
                {
                    ...
                    b.HasIndex("DigitalAssetUrl")
                        .HasFilter("\"DigitalAssetUrl\" IS NOT NULL");
