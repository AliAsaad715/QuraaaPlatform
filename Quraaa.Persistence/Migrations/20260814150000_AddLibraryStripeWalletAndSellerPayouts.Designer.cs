...
namespace Quraaa.Persistence.Migrations
{
    ...
    [Migration("20260814150000_AddLibraryStripeWalletAndSellerPayouts")]
    partial class AddLibraryStripeWalletAndSellerPayouts
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("SellerPayouts", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_SellerPayouts_CommissionPercent_Range", "\"CommissionPercent\" >= 0 AND \"CommissionPercent\" <= 100");

                            t.HasCheckConstraint("CK_SellerPayouts_GrossAmountMinor_Positive", "\"GrossAmountMinor\" > 0");

                            t.HasCheckConstraint("CK_SellerPayouts_NetAmountMinor_Positive", "\"NetAmountMinor\" > 0");
