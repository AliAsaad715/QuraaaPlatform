        ...
        : IEntityTypeConfiguration<SellerPayoutAggregate>
    {
        public void Configure(EntityTypeBuilder<SellerPayoutAggregate> builder)
        {
            builder.ToTable("SellerPayouts", table =>
            {
                ...
                table.HasCheckConstraint(
                    "CK_SellerPayouts_NetAmountMinor_NonNegative",
                    "\"NetAmountMinor\" >= 0");
                ...
                table.HasCheckConstraint(
                    "CK_SellerPayouts_ProfitSharePercent_Range",
            ...
            builder.Property(x => x.ProfitSharePercent)
            ...
            builder.Property(x => x.IdempotencyKeyGeneration).IsRequired();
            ...
            builder.Property(x => x.FailureReason)
                .HasMaxLength(SellerPayoutAggregate.MaxFailureReasonLength);

            builder.Property(x => x.SourcePaymentIntentId)
                .HasMaxLength(255);

            builder.Property(x => x.SourceChargeId)
                .HasMaxLength(255);
