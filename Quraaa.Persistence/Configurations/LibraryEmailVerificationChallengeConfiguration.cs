...
{
    public sealed class LibraryEmailVerificationChallengeConfiguration
        : IEntityTypeConfiguration<LibraryEmailVerificationChallenge>
    {
        public void Configure(EntityTypeBuilder<LibraryEmailVerificationChallenge> builder)
        {
            builder.ToTable("LibraryEmailVerificationChallenges");
            ...
            builder.HasOne<LibraryAggregate>()
                .WithOne()
                .HasForeignKey<LibraryEmailVerificationChallenge>(challenge => challenge.LibraryId)
