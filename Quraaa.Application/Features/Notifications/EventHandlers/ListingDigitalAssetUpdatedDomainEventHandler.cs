...
{
    public sealed class ListingDigitalAssetUpdatedDomainEventHandler
        : INotificationHandler<DomainEventNotification<ListingDigitalAssetUpdatedDomainEvent>>
    {
        ...
        public ListingDigitalAssetUpdatedDomainEventHandler(
            ...
            CancellationToken cancellationToken)
        {
            ...
            var buyerUserIds = await _bookPurchaseRepository.GetDistinctBuyerUserIdsByListingAsync(
                domainEvent.ListingId, cancellationToken);
            ...
            var data = new Dictionary<string, string>
            {
                ...
                ["listingId"] = domainEvent.ListingId.ToString()
            };
